          ...
          <div className="header--text w-[50%] max-lg:w-full">
            ...
            <div className="buttons">
              <button className="  mt-5 shadow-xl mr-5">
                <Link className="flex bg-gray-800 text-white px-10 py-3" to={'/dashboard'}>Dashboard</Link>
              </button>
              <button className=" mt-5 shadow-xl">
                <Link className="px-10 py-3 flex bg-gray-800 text-white " to={'/login'}>Login</Link>
              </button>
            </div>
          </div>
