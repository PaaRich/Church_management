    ...
    <div className="w-5/6">
      ...
      <div className="flex items-start justify-between mt-20">
        ...
        <div className="w-2/5 relative">
          <select
            className="py-3 px-5 w-full bg-slate-200"
            name="Platform"
            id=""
          >
            <option value="" disabled selected>
        ...
        {/* dd */}
        <div className="w-2/5 relative">
          <select className="py-3 px-5 w-full bg-slate-200" name="Group" id="">
            <option value="" disabled selected>
              Target Group
            </option>
      ...
      <div className="w-full relative">
        <button className="bg-slate-950 text-white mt-10 py-3 w-3/6 absolute left-1/2 -translate-x-1/2">
          Scheduling Meeting
        </button>
      </div>
    </div>
